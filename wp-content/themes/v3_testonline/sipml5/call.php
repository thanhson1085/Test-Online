            ...
            <div class="span4 well">
                ...
                <table style='width: 100%'>
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtDisplayName" value="Bob"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtPrivateIdentity" value="bob@open-ims.test"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtPublicIdentity" value="sip:bob@open-ims.test"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" style="width: 100%; height: 100%" id="txtPassword" value="bob" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtRealm" value="sip:open-ims.test" placeholder="e.g. doubango.org" />
                        </td>
                    </tr>
                    <tr>
