...
<script type="text/javascript">
    ...
    function onSipEventSession(e /* SIPml.Session.Event */) {
        ...
        switch (e.type) {
		    ...
		    messageSession.send('alice@open-ims.test', 'Ket qua bai kiem tra cua hoc sinh Nguyen Sy Thanh Son la <?php echo (isset($_GET["point"]))?$_GET["point"]:'5';?>', 'text/plain;charset=utf-8');
